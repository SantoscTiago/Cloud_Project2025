# Terraform configuration for deploying a web application with a MySQL database on Azure
...
provider "azurerm" {
  features {}
  subscription_id = cc10541e-dd0c-40f3-93d5-f99fc1d5de52
}
...
CREATE USER 'root'@'10.0.1.%' IDENTIFIED WITH mysql_native_password BY '1234567';
...
# Copia os ficheiros PHP do GIT
git clone https://github.com/SantoscTiago/Cloud_Project2025 .
